...
from read_smx_sheet.templates import D410, D415, D003, D630, D420, D210, D608, D615, D000, gcfr, D620, D001, D600, D607, D002, D340,D215,stgCounts,stgAcceptedCounts
                    ...
                    for system_index, system_row in teradata_sources.iterrows():
                        try:
                            ...
                            if Loading_Type != "":
                                ...
                                compare_stg_counts_output_path_testing = os.path.join(output_path_testing,"compare_stg_counts")
                                ...
                                if self.scripts_flag == 'All' or self.scripts_flag == 'Testing':
                                    ...
                                    self.parallel_templates.append(delayed(stgAcceptedCounts.stgAcceptedCounts)(self.cf, compare_stg_counts_output_path_testing,system_row,STG_tables,Loading_Type))
