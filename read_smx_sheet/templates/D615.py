...
def d615(cf, source_output_path, Core_tables,STG_tables):
    ...
    insert_statement = f"INSERT INTO {cf.GCFR_t}.GCFR_Transform_KeyCol(OUT_DB_NAME, OUT_OBJECT_NAME, KEY_COLUMN)\n"
    with_statement = "WITH\n"
    key_tables_core = ""
    all_keys_core = ""
    key_tables_stg = ""
