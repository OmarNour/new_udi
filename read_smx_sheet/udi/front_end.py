...
from functions import generate_run_id
...
class FrontEnd:
    ...
    def start_new(self):
        ...
        test = start(run_id, self.db_prefix, r'{}'.format(self.smx_path), r'{}'.format(self.output_path), self.source_names, with_scripts=True, with_deploy=False)
